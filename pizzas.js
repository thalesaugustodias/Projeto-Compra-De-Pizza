let pizzaJson = [
    ...
    {id:2, name:'Calabresa', img:'images/pizza2.png', price:18.01, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    ...
    {id:8, name:'Mista', img:'images/pizza8.png', price:20.50, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'},
    {id:9, name:'Portuguesa', img:'images/pizza9.png', price:22.50, sizes:['320g', '530g', '860g'], description:'Descrição da pizza em mais de uma linha muito legal bem interessante'}
];